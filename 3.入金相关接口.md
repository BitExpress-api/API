...
|p2 |是|string |BitExpress分配的商户号（UID）,可在BitExpressApp->api配置或http://merchant.bitexpress.me网站上获取  |
...
```
{
	"code": 200,
	"data": {
		"url": "http://pay.bitexpress.me?depositId=12"
	},
	"message": "success"
}
```
...
**请求URL：** 
- `由商户通过BitExpress APP 或者 登录BitExpress商户网站（http://merchant.bitexpress.me）配置回调地址 `
