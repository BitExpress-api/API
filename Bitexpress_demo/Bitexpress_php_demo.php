...
class Bitexpress{
    ...
    private $into_url = "http://merchant-api.bitexpress.me/api/recharge/check/v2";  //入金地址
	private $rmb_price_url = "http://merchant-api.bitexpress.me/api/recharge/convert/v1";//查询报价
    private $order_query_url = "http://merchant-api.bitexpress.me/api/recharge/order/query"; //查询订单状态
	private $withdrawal_url = "http://merchant-api.bitexpress.me/api/recharge/customer/withdrawal"; //法币出金申请
    private $withdrawal_history_url = "http://merchant-api.bitexpress.me/api/recharge/customer/withdrawal/history"; //法币入金申请历史
    private $withdrawal_delete_url = "http://merchant-api.bitexpress.me/api/recharge/customer/withdrawal/delete"; //删除未审核的法币出金申请记录
...
//curl -X GET -H "content-type:application/json" -H "access_key:8A42FADDD2397F4841B1F85C2C13094CAB152151" -H "app_id:41043343" http://merchant-api.bitexpress.me/api/recharge/convert/v1?timestamp=1609385362&p1=9357&p2=CNY&p3=695
    ...
    function httpGET($url,$str) {
        ...
        echo 'url:'.$url."</br>";    //请求地址和参数：http://merchant-api.bitexpress.me/api/recharge/check/v2?p1=100&p2=11082429&p3=1553155910&timestamp=1553155910
